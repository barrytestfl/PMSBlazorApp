...
var Sentry = function(t) {
    ...
    const p = "object" == typeof globalThis && d(globalThis) || "object" == typeof window && d(window) || "object" == typeof self && d(self) || "object" == typeof global && d(global) || function() {
        return this
    }() || {};
    function m() {
        return p
    ...
    function _(t, n) {
        ...
        const h = n && n.length ? n.filter((t=>e.getAttribute(t))).map((t=>[t, e.getAttribute(t)])) : null;
        if (h && h.length)
            h.forEach((t=>{
                r.push(`[${t[0]}="${t[1]}"]`)
            }
    ...
    function T(t) {
        return "string" == typeof t ? function(t) {
            ...
            let u = ""
              , a = c;
            const h = a.split("/");
            if (h.length > 1 && (u = h.slice(0, -1).join("/"),
            a = h.pop()),
            a) {
                const t = a.match(/^\d+/);
                t && (a = t[0])
    ...
    function O(t, n, e=!1) {
        return !!o(t) && (r(n, "RegExp") ? n.test(t) : !!o(n) && (e ? t === n : t.includes(n)))
    }
    function j(t, n=[], e=!1) {
    ...
    function L(t) {
        ...
        if (a(t)) {
            ...
            return "undefined" != typeof CustomEvent && l(t, CustomEvent) && (n.detail = t.detail),
            n
        }
        return t
    }
    function A(t) {
        try {
            return n = t,
            "undefined" != typeof Element && l(n, Element) ? g(t) : Object.prototype.toString.call(t)
        } catch (t) {
            return "<unknown>"
        }
        var n
            ...
            case "console":
                !function() {
                    if (!("console"in W))
                        return;
                    $.forEach((function(t) {
                        t in W.console && R(W.console, t, (function(n) {
                            return function(...e) {
                                Y("console", {
                                    args: e,
                                    level: t
            ...
            case "dom":
                !function() {
                    ...
                    ["EventTarget", "Node"].forEach((n=>{
                        ...
                        e && e.hasOwnProperty && e.hasOwnProperty("addEventListener") && (R(e, "addEventListener", (function(n) {
                ...
                !function() {
                    ...
                    R(t, "open", (function(t) {
                        return function(...n) {
                            ...
                            return "onreadystatechange"in e && "function" == typeof e.onreadystatechange ? R(e, "onreadystatechange", (function(t) {
                                return function(...n) {
                                    return s(),
                                    t.apply(e, n)
                                }
                    ...
                    if (!function() {
                        ...
                        if (n && "function" == typeof n.createElement)
                            try {
                                ...
                                e.contentWindow && e.contentWindow.fetch && (t = z(e.contentWindow.fetch)),
                ...
                !function() {
                    if (!function() {
                        const t = B.chrome
                          ...
                          , e = "history"in B && !!B.history.pushState && !!B.history.replaceState;
                        return !n && e
                    }())
                        return;
    ...
    function Q(t=[]) {
        return "Request"in W && l(t[0], Request) && t[0].method ? String(t[0].method).toUpperCase() : t[1] && t[1].method ? String(t[1].method).toUpperCase() : "GET"
    }
    function Z(t=[]) {
        return "string" == typeof t[0] ? t[0] : "Request"in W && l(t[0], Request) ? t[0].url : String(t[0])
    }
    let tt;
    let nt, et;
    function rt(t, n=!1) {
    ...
    function pt(t, n=3, e=102400) {
        ...
        }(JSON.stringify(i)) > e ? pt(t, n - 1, e) : r;
        var i
    }
    function mt(t, n, e=1 / 0, r=1 / 0, i=function() {
        ...
        const [s,o] = i;
        if (null === n || ["number", "boolean", "string"].includes(typeof n) && !f(n))
            return n;
    ...
    class _t {
        ...
        __init5() {
            this.p = (t,n)=>{
                this.i === yt.PENDING && (h(n) ? n.then(this.u, this.h) : (this.i = t,
                this.m = n,
                this.l()))
            }
        }
        __init6() {
            this.l = ()=>{
                if (this.i === yt.PENDING)
                    return;
                const t = this.o.slice();
                this.o = [],
                t.forEach((t=>{
                    t[0] || (this.i === yt.RESOLVED && t[1](this.m),
        ...
        return {
            ...
            add: function(r) {
                if (!(void 0 === t || n.length < t))
                    return gt(new b("Not adding Promise because buffer limit was reached."));
                const i = r();
    ...
    const $t = function() {
      ...
      , Ct = new RegExp("^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$");
    function It(t, n=[]) {
        return [t, n]
    }
    function Dt(t, n) {
    ...
    function Mt(t, n) {
        ...
        function s(t) {
            "string" == typeof i ? i = "string" == typeof t ? i + t : [At(i, n), t] : i.push("string" == typeof t ? At(t, n) : t)
        }
        for (const t of r) {
            const [n,e] = t;
            if (s(`\n ${JSON.stringify(n)}\n`),
    ...
    function Nt(t, n) {
        const e = "string" == typeof t.data ? At(t.data, n) : t.data;
        return [q({
            type: "attachment",
            length: e.length,
            filename: t.filename,
    ...
    function zt(t) {
        ...
        }(Object.entries(t).reduce(((t,[n,e])=>(e && (t[`sentry-${n}`] = e),
        t)), {}))
    }
    function Wt(t) {
        return t.split(",").map((t=>t.split("=").map((t=>decodeURIComponent(t.trim()))))).reduce(((t,[n,e])=>(t[n] = e,
        t)), {})
    }
    function Jt(t) {
        const n = Ot()
    ...
    class Gt {
        ...
        setSession(t) {
            return t ? this.L = t : delete this.L,
            this.q(),
            this
        }
        getSession() {
        ...
        update(t) {
            ...
            t.fingerprint && (this.M = t.fingerprint),
        ...
        applyToEvent(t, n={}) {
            ...
            this.R && Object.keys(this.R).length && (t.contexts = {
                ...this.R,
                ...t.contexts
            }),
            this.I && (t.level = this.I),
            this.A && (t.transaction = this.A),
            this.D) {
                t.contexts = {
                    trace: this.D.getTraceContext(),
                    ...t.contexts
                };
        ...
        U(t, n, e, r=0) {
            return new _t(((i,s)=>{
                ...
                if (null === n || "function" != typeof o)
                    ...
                    h(c) ? c.then((n=>this.U(t, n, e, r + 1).then(i))).then(null, s) : this.U(t, c, e, r + 1).then(i).then(null, s)
                }
            }
            ))
        }
        ...
        P(t) {
            ...
            this.M && (t.fingerprint = t.fingerprint.concat(this.M)),
    ...
    function en() {
        const t = tn();
        var n;
        return (n = t) && n.__SENTRY__ && n.__SENTRY__.hub && !rn(t).isOlderThan(4) || sn(t, new Zt),
        rn(t)
    }
    function rn(t) {
    ...
    function ln(t) {
        ...
        r = Array.isArray(e) ? [...n, ...e] : "function" == typeof e ? lt(e(n)) : n;
        const i = function(t) {
            const n = {};
            return t.forEach((t=>{
                const {name: e} = t
    ...
    function dn(t, n, e, r) {
        ...
        let c = r;
        e.captureContext && (c = Gt.clone(c).update(e.captureContext));
        let u = vt(o);
        if (c) {
            if (c.getAttachments) {
            ...
            u = c.applyToEvent(o, e)
        }
        return u.then((t=>"number" == typeof i && i > 0 ? function(t, n, e) {
            if (!t)
                return null;
            const r = {
                ...t,
                ...
                ...t.contexts && {
                    contexts: dt(t.contexts, n, e)
                },
                ...t.extra && {
                    extra: dt(t.extra, n, e)
                }
            };
            t.contexts && t.contexts.trace && r.contexts && (r.contexts.trace = t.contexts.trace,
            t.contexts.trace.data && (r.contexts.trace.data = dt(t.contexts.trace.data, n, e)));
            t.spans && (r.spans = t.spans.map((t=>(t.data && (t.data = dt(t.data, n, e)),
            t))));
            return r
        }(t, i, s) : t))
    }
    class pn {
        ...
        captureEvent(t, n, e) {
            if (n && n.originalException && ft(n.originalException))
                return;
            let r = n && n.event_id;
        ...
        captureSession(t) {
            this.st() && ("string" != typeof t.release || (this.sendSession(t),
            Kt(t, {
                init: !1
            })))
        }
        ...
        flush(t) {
            const n = this.et;
            return n ? this.ot(t).then((e=>n.flush(t).then((t=>e && t)))) : vt(!0)
        }
        close(t) {
        ...
        setupIntegrations() {
            this.st() && !this.V && (this.G = function(t) {
                ...
                return t.forEach((t=>{
                    n[t.name] = t,
                    -1 === fn.indexOf(t.name) && (t.setupOnce(Yt, en),
                    fn.push(t.name))
                }
                )),
                n
            }(this.tt.integrations),
            this.V = !0)
        }
        ...
        sendEvent(t, n={}) {
            if (this.nt) {
                let e = hn(t, this.nt, this.tt.K, this.tt.tunnel);
                for (const t of n.attachments || [])
                    e = Dt(e, Nt(t, this.tt.transportOptions && this.tt.transportOptions.textEncoder));
                this.ct(e)
            }
        }
        sendSession(t) {
        ...
        ht(t, n, e) {
            return dn(this.getOptions(), t, n, e)
        }
        it(t, n={}, e) {
            return this.ft(t, n, e).then((t=>t.event_id), (t=>{}
            ))
        }
        ft(t, n, e) {
            ...
            gt(new b(`Discarding event because it's not included in the random sample (sampling rate = ${i})`,"log"))) : this.ht(t, n, e).then((e=>{
                if (null === e)
                    throw this.recordDroppedEvent("event_processor", c, t),
                    new b("An event processor returned `null`, will not send event.","log");
    ...
    function vn(t, n, e=bt(t.bufferSize || 30)) {
        let r = {};
        return {
            send: function(i) {
                const s = [];
    ...
    function Rn(t, n={}, e) {
        ...
        const sentryWrapped = function() {
            ...
            try {
                ...
                const i = r.map((t=>Rn(t, n)));
                return t.apply(this, i)
            } catch (t) {
                throw jn(),
                on((e=>{
                    e.addEventProcessor((t=>(n.mechanism && (at(t, void 0, void 0),
                    ht(t, n.mechanism)),
                    t.extra = {
                        ...t.extra,
                        arguments: r
        ...
        I(sentryWrapped, t),
        C(t, "__sentry_wrapped__", sentryWrapped);
        try {
    ...
    class Un {
        ...
        setupOnce() {
            this.options.console && V("console", Hn),
            this.options.dom && V("dom", function(t) {
                function n(n) {
                    ...
                    "string" == typeof r && (r = [r]);
                    try {
                        e = n.event.target ? g(n.event.target, {
                            keyAttrs: r,
                            maxStringLength: i
                        }) : g(n.event, {
                            keyAttrs: r,
            ...
            this.options.xhr && V("xhr", Fn),
            this.options.fetch && V("fetch", Bn),
            this.options.history && V("history", Xn)
        }
    ...
    function Hn(t) {
        ...
        const n = {
            ...
            level: (e = t.level,
            "warn" === e ? "warning" : St.includes(e) ? e : "log"),
            message: k(t.args, " ")
        };
        var e;
        if ("assert" === t.level) {
    ...
    function Bn(t) {
        t.endTimestamp && (t.fetchData.url.match(/sentry_key/) && "POST" === t.fetchData.method || (t.error ? en().addBreadcrumb({
            category: "fetch",
            data: t.fetchData,
            level: "error",
            type: "http"
    ...
    class zn extends pn {
        constructor(t) {
            ...
            super(t),
            t.sendClientReports && xn.document && xn.document.addEventListener("visibilitychange", (()=>{
                "hidden" === xn.document.visibilityState && this.dt()
            }
            ))
        }
        eventFromException(t, n) {
            return function(t, n, e, r) {
                const i = Mn(t, n, e && e.syntheticException || void 0, r);
                return ht(i),
                i.level = "error",
        ...
        eventFromMessage(t, n="info", e) {
            return function(t, n, e="info", r, i) {
                const s = Nn(t, n, r && r.syntheticException || void 0, i);
                return s.level = e,
            ...
            !function(t) {
                ...
                for (; r < t.length; ) {
                    const i = t[r]
                      , s = t[r + 1];
                    if (r += 2,
                    ("optionalAccess" === i || "optionalCall" === i) && null == e)
                        return;
                    "access" === i || "optionalAccess" === i ? (n = e,
                    e = s(e)) : "call" !== i && "optionalCall" !== i || (e = s(((...t)=>e.call(n, ...t))),
                    n = void 0)
                }
            }([this.getIntegrationById(Pn), "optionalAccess", t=>t.addSentryBreadcrumb, "optionalCall", n=>n(t)]),
            super.sendEvent(t, n)
        }
        ht(t, n, e) {
        ...
        dt() {
            ...
            if (!this.nt)
                return;
            const n = an(this.nt, this.tt)
              , e = (r = t,
            It((i = this.tt.tunnel && S(this.nt)) ? {
                dsn: i
            } : {}, [[{
                type: "client_report"
            }, {
            ...
            var r, i, s;
            try {
                const t = "[object Navigator]" === Object.prototype.toString.call(xn && xn.navigator);
                if (t && "function" == typeof xn.navigator.sendBeacon && !this.tt.transportOptions) {
                    xn.navigator.sendBeacon.bind(xn.navigator)(n, Mt(e))
                } else
                    this.ct(e)
            } catch (t) {}
        }
    ...
    let Wn;
    function Jn(t, n=function() {
        if (Wn)
            return Wn;
        if (z(xn.fetch))
            return Wn = xn.fetch.bind(xn);
        const t = xn.document;
        let n = xn.fetch;
    ...
    const Yn = /^\s*at (?:(.*\).*?|.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i
      , Qn = /\((\S*)(?::(\d+))(?::(\d+))\)/
      , Zn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|safari-extension|safari-web-extension|capacitor)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i
      ...
      , ee = U(...[[30, t=>{
        ...
        if (n) {
            ...
            const [t,e] = re(n[1] || Gn, n[2]);
            return Vn(e, t, n[3] ? +n[3] : void 0, n[4] ? +n[4] : void 0)
        }
    }
    ], [50, t=>{
        const n = Zn.exec(t);
        ...
        const n = ne.exec(t);
        return n ? Vn(n[2], n[1] || Gn, +n[3], n[4] ? +n[4] : void 0) : void 0
    }
    ]])
      , re = (t,n)=>{
        const e = -1 !== t.indexOf("safari-extension")
          , r = -1 !== t.indexOf("safari-web-extension");
        return e || r ? [-1 !== t.indexOf("@") ? t.split("@")[0] : Gn, e ? `safari-extension:${n}` : `safari-web-extension:${n}`] : [t, n]
    }
    ;
    class ie {
        static __initStatic() {
    ...
    function se() {
        V("error", (t=>{
            const [n,e,r] = ae();
            if (!n.getIntegration(ie))
                return;
            const {msg: s, url: c, line: u, column: a, error: h} = t;
            if (On() || h && h.__sentry_own_request__)
                return;
            const f = void 0 === h && o(s) ? function(t, n, e, r) {
            ...
            }(s, c, u, a) : ce(Mn(e, h || s, void 0, r, !1), c, u, a);
            f.level = "error",
            ue(n, h, f, "onerror")
        }
        ))
    ...
    function oe() {
        V("unhandledrejection", (t=>{
            ...
            if (On() || i && i.__sentry_own_request__)
                return !0;
            const s = c(i) ? {
                exception: {
                    values: [{
    ...
    class fe {
        ...
        setupOnce() {
            this.tt.setTimeout && R(xn, "setTimeout", le),
            this.tt.setInterval && R(xn, "setInterval", le),
            this.tt.requestAnimationFrame && R(xn, "requestAnimationFrame", de),
            this.tt.XMLHttpRequest && "XMLHttpRequest"in xn && R(XMLHttpRequest.prototype, "send", pe);
            const t = this.tt.eventTarget;
            if (t) {
                (Array.isArray(t) ? t : he).forEach(me)
            }
        }
    }
    function le(t) {
    ...
    function pe(t) {
        return function(...n) {
            ...
            return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((t=>{
                t in e && "function" == typeof e[t] && R(e, t, (function(n) {
                    const e = {
                        mechanism: {
                            data: {
                                function: t,
                      ...
                      , r = D(n);
                    return r && (e.mechanism.data.handler = F(r)),
                    Rn(n, e)
                }
                ))
            }
    ...
    function me(t) {
        ...
        e && e.hasOwnProperty && e.hasOwnProperty("addEventListener") && (R(e, "addEventListener", (function(n) {
            return function(e, r, i) {
                try {
                    "function" == typeof r.handleEvent && (r.handleEvent = Rn(r.handleEvent, {
                        mechanism: {
                            data: {
    ...
    class ye {
        ...
        setupOnce() {
            ...
            t && Yt(((n,e)=>{
                const r = en().getIntegration(ye);
                return r ? function(t, n, e, r, i) {
                    if (!(r.exception && r.exception.values && i && l(i.originalException, Error)))
                        return r;
                    const s = ve(t, e, i.originalException, n);
                    return r.exception.values = [...s, ...r.exception.values],
                    r
                }(t.getOptions().stackParser, r.vt, r.gt, n, e) : n
            }
            ))
        }
    }
    function ve(t, n, e, r, i=[]) {
        if (!l(e[r], Error) || i.length + 1 >= n)
            return i;
        const s = Cn(t, e[r]);
        return ve(t, n, e[r], r, [s, ...i])
    }
    ye.__initStatic();
    class ge {
        constructor() {
        ...
        setupOnce() {
            Yt((t=>{
                if (en().getIntegration(ge)) {
                    if (!xn.navigator && !xn.location && !xn.document)
                        return t;
                    const n = t.request && t.request.url || xn.location && xn.location.href
                      , {referrer: e} = xn.document || {}
                      , {userAgent: r} = xn.navigator || {}
                      , i = {
                        ...n && {
                            url: n
                        },
    ...
    const $e = [new En, new wn, new fe, new Un, new ie, new ye, new _e, new ge];
    function xe(t) {
        t.startSession({
            ignoreDuration: !0
        }),
    ...
    let ke = {};
    xn.Sentry && xn.Sentry.Integrations && (ke = xn.Sentry.Integrations);
    const Oe = {
        ...ke,
        ...$n,
        ...Te
    ...
    class Le {
        ...
        add(t) {
            this.spans.length > this.bt ? t.spanRecorder = void 0 : this.spans.push(t)
        }
    }
    class Ae {
        __init2() {
        ...
        updateWithContext(t) {
            return this.data = De(t.data, (()=>({}))),
            this.description = t.description,
            this.endTimestamp = t.endTimestamp,
            this.op = t.op,
            this.parentSpanId = t.parentSpanId,
            this.sampled = t.sampled,
            this.spanId = De(t.spanId, (()=>this.spanId)),
            this.startTimestamp = De(t.startTimestamp, (()=>this.startTimestamp)),
            this.status = t.status,
            this.tags = De(t.tags, (()=>({}))),
            this.traceId = De(t.traceId, (()=>this.traceId)),
            this
        }
        getTraceContext() {
            return q({
    ...
    class Me extends Ae {
        ...
        setName(t, n="custom") {
            t === this.name && n === this.metadata.source || this.metadata.changes.push({
        ...
        finish(t) {
            ...
            this.$t && n.length > 0 && (this.endTimestamp = n.reduce(((t,n)=>t.endTimestamp && n.endTimestamp ? t.endTimestamp > n.endTimestamp ? t : n : t)).endTimestamp);
            ...
            return Object.keys(this.wt).length > 0 && (r.measurements = this.wt),
            this.Et.captureEvent(r)
        }
        toContext() {
            return q({
                ...super.toContext(),
    ...
    class Ne extends Le {
        ...
        add(t) {
            ...
            ,
            void 0 === t.endTimestamp && this.xt(t.spanId)),
            super.add(t)
        }
    }
    class qe extends Me {
        ...
        constructor(t, n, e=1e3, r=3e4, i=5e3, s=!1) {
            ...
            s && (Pe(n),
            n.configureScope((t=>t.setSpan(this)))),
            this.Mt(),
            setTimeout((()=>{
                this.jt || (this.setStatus("deadline_exceeded"),
                this.finish())
            }
            ), this.Dt)
        }
        ...
        initSpanRecorder(t) {
            if (!this.spanRecorder) {
                ...
                ;
                this.spanRecorder = new Ne(n,e,this.spanId,t),
                this.Nt()
            }
            this.spanRecorder.add(this)
        }
        ...
        Mt(t) {
            this.qt(),
            this.Pt = setTimeout((()=>{
                this.jt || 0 !== Object.keys(this.activities).length || this.finish(t)
            }
            ), this.It)
        }
        xt(t) {
        ...
        Ut() {
            ...
            t === this.Ht ? this.Ot++ : this.Ot = 1,
            this.Ht = t,
            this.Ot >= 3 ? (this.setStatus("deadline_exceeded"),
            this.finish()) : this.Nt()
        }
        Nt() {
            setTimeout((()=>{
    ...
    function He(t, n, e) {
        ...
        if (void 0 !== t.sampled)
            ...
            t;
        let r;
        return "function" == typeof n.tracesSampler ? (r = n.tracesSampler(e),
        t.setMetadata({
            sampleRate: Number(r)
        })) : void 0 !== e.parentSampled ? r = e.parentSampled : (r = n.tracesSampleRate,
        t.setMetadata({
            sampleRate: Number(r)
        })),
        function(t) {
            if (f(t) || "number" != typeof t && "boolean" != typeof t)
                return !1;
            if (t < 0 || t > 1)
                return !1;
            return !0
    ...
    function Be(t, n, e, r, i, s, o) {
        ...
        a.sampled && a.initSpanRecorder(u._experiments && u._experiments.maxSpans),
        a
    }
    function Xe() {
        !function() {
            ...
            t.__SENTRY__.extensions.startTransaction || (t.__SENTRY__.extensions.startTransaction = Fe),
            t.__SENTRY__.extensions.traceHeaders || (t.__SENTRY__.extensions.traceHeaders = Ue))
        }(),
        V("error", Ie),
        V("unhandledrejection", Ie)
    }
    const ze = p;
    const We = (t,n,e)=>{
        let r, i;
        return s=>{
            n.value >= 0 && (s || e) && (i = n.value - (r || 0),
            (i || void 0 === r) && (r = n.value,
            n.delta = i,
            t(n)))
        }
    }
      , Je = ()=>ze.__WEB_VITALS_POLYFILL__ ? ze.performance && (performance.getEntriesByType && performance.getEntriesByType("navigation")[0] || (()=>{
    ...
    )()) : ze.performance && performance.getEntriesByType && performance.getEntriesByType("navigation")[0]
      , Ke = ()=>{
        const t = Je();
      ...
      , Ge = (t,n)=>{
        const e = Je();
        let r = "navigate";
        return e && (r = ze.document.prerendering || Ke() > 0 ? "prerender" : e.type.replace(/_/g, "-")),
        {
            name: t,
            value: void 0 === n ? -1 : n,
            rating: "good",
      ...
      , Ye = (t,n)=>{
        const e = r=>{
            "pagehide" !== r.type && "hidden" !== ze.document.visibilityState || (t(r),
    ...
    ;
    let Qe = -1;
    const Ze = ()=>(Qe < 0 && (Qe = "hidden" !== ze.document.visibilityState || ze.document.prerendering ? 1 / 0 : 0,
    Ye((({timeStamp: t})=>{
        Qe = t
    }
    ), !0)),
    ...
    function ur() {
        const t = rr();
        t && Rt && (t.mark && ze.performance.mark("sentry-tracing-init"),
        (t=>{
            const n = Ge("CLS", 0);
            let e, r = 0, i = [];
            const s = t=>{
        ...
        (t=>{
            ...
            let r;
            const i = t=>{
                t.startTime < n.firstHiddenTime && (e.value = t.processingStart - t.startTime,
                e.entries.push(t),
                r(!0))
            }
              , s = t=>{
    ...
    function ar(t) {
        const n = rr();
        if (!n || !ze.performance.getEntries || !Rt)
            return;
        const e = Ce(Rt)
          , r = n.getEntries();
        let i, s;
        if (r.slice(or).forEach((n=>{
            const r = Ce(n.startTime)
              , o = Ce(n.duration);
                    ...
                    !function(t, n, e) {
                        ...
                        function(t, n, e) {
                            er(t, {
                                op: "browser",
                                description: "request",
                                startTimestamp: e + Ce(n.requestStart),
                                endTimestamp: e + Ce(n.responseEnd)
                            }),
                            er(t, {
                                op: "browser",
                                description: "response",
                                startTimestamp: e + Ce(n.responseStart),
                                endTimestamp: e + Ce(n.responseEnd)
                            })
                        }(t, n, e)
                    }(t, n, e),
                    i = e + Ce(n.responseStart),
                    s = e + Ce(n.requestStart);
                    break;
                case "mark":
                case "paint":
                case "measure":
                    {
                        ...
                        "first-paint" === n.name && s && (cr.fp = {
                            value: n.startTime,
                            unit: "millisecond"
                        }),
                        "first-contentful-paint" === n.name && s && (cr.fcp = {
                            value: n.startTime,
                            unit: "millisecond"
                        });
                        break
        ...
        function(t) {
            ...
            nr(e.rtt) && (cr["connection.rtt"] = {
                value: e.rtt,
                unit: "millisecond"
            }));
            nr(n.deviceMemory) && t.setTag("deviceMemory", `${n.deviceMemory} GB`);
            nr(n.hardwareConcurrency) && t.setTag("hardwareConcurrency", String(n.hardwareConcurrency))
        }(t),
        "pageload" === t.op) {
            "number" == typeof i && (cr.ttfb = {
            ...
            n && cr.fid && (er(t, {
                ...
                endTimestamp: n.value + Ce(cr.fid.value),
                op: "ui.action",
            ...
            function(t) {
                ir && (ir.element && t.setTag("lcp.element", g(ir.element)),
                ir.id && t.setTag("lcp.id", ir.id),
                ir.url && t.setTag("lcp.url", ir.url.trim().slice(0, 200)),
                t.setTag("lcp.size", ir.size));
                sr && sr.sources && sr.sources.forEach(((n,e)=>t.setTag(`cls.source.${e + 1}`, g(n.node))))
            }(t)
        }
        ir = void 0,
        sr = void 0,
    ...
    function dr(t) {
        const {traceFetch: n, traceXHR: e, tracePropagationTargets: r, tracingOrigins: i, shouldCreateSpanForRequest: s} = {
            traceFetch: lr.traceFetch,
            traceXHR: lr.traceXHR,
            ...t
        }
        ...
        n && V("fetch", (t=>{
            !function(t, n, e, r) {
                if (!je() || !t.fetchData || !n(t.fetchData.url))
                    return;
                if (t.endTimestamp) {
                    ...
                    if (!n)
                        return;
                    const e = r[n];
                    return void (e && (t.response ? e.setHttpStatus(t.response.status) : t.error && e.setStatus("internal_error"),
                    e.finish(),
                    delete r[n]))
                }
                const i = Re();
                if (i) {
                    ...
                    t.args[1] = t.args[1] || {};
                    const o = t.args[1];
                    e(t.fetchData.url) && (o.headers = function(t, n, e, r) {
                        const i = zt(n)
                          , s = e.toTraceparent()
                          , o = "undefined" != typeof Request && l(t, Request) ? t.headers : r.headers;
                        if (o) {
                            ...
                            if (Array.isArray(o)) {
                                ...
                                return i && t.push([Ft, i]),
                                t
                            }
                            {
                                const t = "baggage"in o ? o.baggage : void 0
                                  , n = [];
                                return Array.isArray(t) ? n.push(...t) : t && n.push(t),
                                i && n.push(i),
                                {
                                    ...o,
                                    "sentry-trace": s,
                    ...
                    }(s, i.getDynamicSamplingContext(), n, o),
        ...
        e && V("xhr", (t=>{
            !function(t, n, e, r) {
                if (!je() || t.xhr && t.xhr.__sentry_own_request__ || !(t.xhr && t.xhr.__sentry_xhr__ && n(t.xhr.__sentry_xhr__.url)))
                    return;
                ...
                if (t.endTimestamp) {
                    ...
                    if (!n)
                        return;
                    const e = r[n];
                    return void (e && (e.setHttpStatus(i.status_code),
                    e.finish(),
                    delete r[n]))
                }
                const s = Re();
                if (s) {
                    ...
                    if (t.xhr.__sentry_xhr_span_id__ = n.spanId,
                    ...
                    t.xhr.setRequestHeader && e(t.xhr.__sentry_xhr__.url))
                        try {
                            ...
                            const e = zt(s.getDynamicSamplingContext());
                            e && t.xhr.setRequestHeader(Ft, e),
                            s.metadata.propagations++
                        } catch (t) {}
                }
            }(t, o, c, u)
        }
    ...
    const mr = {
        ...
        routingInstrumentation: function(t, n=!0, e=!0) {
            ...
            e && V("history", (({to: n, from: e})=>{
                void 0 === e && i && -1 !== i.indexOf(n) ? i = void 0 : e !== n && (i = void 0,
                r && r.finish(),
                r = t({
                    name: ze.location.pathname,
                    op: "navigation",
    ...
    class yr {
        ...
        constructor(t) {
            ...
            ur(),
            pr([this, "access", t=>t.options, "access", t=>t._experiments, "optionalAccess", t=>t.enableLongTask]) && Ve("longtask", (t=>{
                for (const n of t) {
                    const t = Re();
                    if (!t)
                        return;
                    const e = Ce(Rt + n.startTime)
                      , r = Ce(n.duration);
                    t.startChild({
        ...
        setupOnce(t, n) {
            this.Ft = n;
            const {routingInstrumentation: e, startTransactionOnLocationChange: r, startTransactionOnPageLoad: i, markBackgroundTransactions: s, traceFetch: o, traceXHR: c, tracePropagationTargets: u, shouldCreateSpanForRequest: a, _experiments: h} = this.options;
            e((t=>this.Bt(t)), i, r),
            s && ze && ze.document && ze.document.addEventListener("visibilitychange", (()=>{
                const t = Re();
            ...
            pr([h, "optionalAccess", t=>t.enableInteractions]) && this.Xt(),
            dr({
                traceFetch: o,
                traceXHR: c,
        ...
        Bt(t) {
            if (!this.Ft)
                return;
            const {beforeNavigate: n, idleTimeout: e, finalTimeout: r, heartbeatInterval: i} = this.options
              , s = "pageload" === t.op
              , c = s ? vr("sentry-trace") : null
              , u = s ? vr("baggage") : null
              , a = c ? function(t) {
                const n = t.match(Ct);
                if (!t || !n)
              ...
              , h = u ? function(t) {
                ...
                const e = Object.entries(n).reduce(((t,[n,e])=>(n.match(Xt) && (t[n.slice(Bt.length)] = e),
                t)), {});
            ...
            d.metadata = d.name !== f.name ? {
                ...d.metadata,
                source: "custom"
            } : d.metadata,
            this.zt = d.name,
            this.Wt = pr([d, "access", t=>t.metadata, "optionalAccess", t=>t.source]);
            const p = this.Ft()
              , {location: m} = ze
              , y = Be(p, d, e, r, !0, {
                location: m
            }, i);
            return y.registerBeforeFinishCallback((t=>{
                ar(t)
            }
            )),
            y
        ...
        Xt() {
            let t;
            const n = ()=>{
                const {idleTimeout: n, finalTimeout: e, heartbeatInterval: r} = this.options;
                if (t && (t.finish(),
                t = void 0),
                !this.Ft)
                    return;
    ...
    function vr(t) {
        const n = (e = `meta[name=${t}]`,
        v.document && v.document.querySelector ? v.document.querySelector(e) : null);
        var e;
        return n ? n.getAttribute("content") : null
    }
    let gr = {};
    p.Sentry && p.Sentry.Integrations && (gr = p.Sentry.Integrations);
    const _r = {
        ...gr,
        ...Oe,
        BrowserTracing: yr
    ...
    t.init = function(t={}) {
        ...
        const n = {
            ...t,
            stackParser: (e = t.stackParser || ee,
            Array.isArray(e) ? U(...e) : e),
            integrations: ln(t),
            transport: t.transport || (X() ? Jn : Kn)
        };
        var e;
        !function(t, n) {
    ...
    t.showReportDialog = function(t={}, n=en()) {
        ...
        const s = xn.document.createElement("script");
        s.async = !0,
        s.src = function(t, n) {
            const e = T(t)
        ...
        const o = xn.document.head || xn.document.body;
        o && o.appendChild(s)
    }
    ,
